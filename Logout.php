      ...
      <div class="row" style="margin-top:px">
        	<div class="col-md-6">
              	<div class="row" align="center">
                    <p style="font-size:30x; font-weight:bold"> Thank You!</p>
                </div>
           	  <img src="images/InsideBaker.PNG" width="300" height="450" align="center" alt="Dartmouth Hall"/>
            </div>
            <div class="col-md-6" align="center">
            <div class="row" style="width:400px; margin-top:80px">
              <div class="row" style="margin-top:40px">
              	<p style="color:hsla(0,0%,0%,1.00); font-size:larger; font-weight:bolder">Thank you for using Dartmouth Banner Student Portal. You have successfully logged out.</a>
              </div>
              <div class="row" style="margin-top:40px">
              	<p style="color:hsla(0,0%,0%,1.00); font-size:14px; font-weight:bold">Important Security Information: Please exit your browser for secure logout.</a>
              </div>
       		</div>
      </div>
    </div>
