            ...
            <div class="container-fluid" style="background-color:white; padding:40px">
             <div class="row" style="margin-top:30px;font-size:20px">
              ...
              <div class="row" style="margin-top:15px">
              	<a style="color:#1A5417" target="_blank" href="https://apply.dartmouth.edu/account/reset?r=https%3a%2f%2fapply.dartmouth.edu%2fapply%2fstatus&s=&ds=">Forgot Password?</a>
              </div>
